...
namespace FishNet.Transporting.FishyUTPPlugin
{
    public abstract class CommonSocket
    {
        ...
        /// </summary>
        protected void Receive(DataStreamReader stream, NetworkConnection connection, NetworkPipeline pipeline,
            out ArraySegment<byte> data, out Channel channel, out int connectionId)
        {
