...
namespace FishNet.Transporting.FishyUTPPlugin
{
    ...
    public class FishyUTP : Transport
    {
        ...
        /// </summary>
        [Tooltip("Maximum number of players which may be connected at once.")] [Range(1, 9999)] [SerializeField]
        ...
        /// </summary>
        [Tooltip("Automatically sign in to Unity services when transport is initialized?")] [SerializeField]
